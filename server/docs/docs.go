    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/inspection.inspectionIDRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/inspection.alertIDsRequest"
                        }
                    }
                ],
                "responses": {
                                                ...
                                                },
                                                {
                                                    ...
                                                    "properties": {
                                                        "list": {
                                                            "type": "array",
                                                            "items": {
                                                                "$ref": "#/definitions/inspection.InspAlert"
                                                            }
                                                        }
                                                    }
                                                }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.PatchAlertStatus"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/inspection.InspCluster"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateCluster"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/inspection.InspReport"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateRule"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/inspection.InspRule"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateRule"
                        }
                    }
                ],
                "responses": {
        ...
        "/inspection/rule/enabled": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "规则ID与启用状态",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/inspection.setEnabledRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/inspection.InspTask"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/inspection.InspInspection"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "inspection": {
                    "$ref": "#/definitions/config.Inspection"
                },
                "jwt": {
        ...
        "inspection.InspInspection": {
            ...
            "properties": {
                ...
                "details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/inspection.InspInspectionDetail"
                    }
                },
                "finishedAt": {
                    "type": "string"
        ...
        "inspection.inspectionIDRequest": {
            "type": "object",
            "required": [
                "id"
            ],
